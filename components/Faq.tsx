...
const faqs: QA[] = [
  ...
  },
  {
    ...
    a: "Мы работаем только с современными автобусами комфорт-класса: кондиционер, удобные откидные кресла, туалет, горячие напитки. Каждые 2-3 часа - остановки для отдыха.",
  },
  {
    q: "А что, если мне станет плохо в дороге или на отдыхе?",
    a: "В стоимость каждого тура включена медицинская страховка. На маршруте всегда есть наш сопровождающий, говорящий по-русски, который поможет вызвать врача или решить любую ситуацию. Вы не остаётесь один на один с проблемой.",
  },
  {
